			...
			$datos = array(
				...
				if ($respuesta == "ok") {
					...
					echo '<script>
						...
						swal({
							type: "success",
							title: "El Area Social ha sido guardado correctamente",
				...
				echo '<script>
					...
					swal({
						type: "error",
						title: "¡El Area Social no puede ir con los campos vacíos",
						showConfirmButton: true,
						confirmButtonText: "Cerrar"
						}).then(function(result){
							if (result.value) {
		...
		if(isset($_POST["editarNombreServicio"])) {
			...
			$datos = array(
				...
				if ($respuesta == "ok") {
					...
					swal({
						type: "success",
						title: "El Area Social ha sido cambiado correctamente",
						showConfirmButton: true,
						confirmButtonText: "Cerrar"
						}).then(function(result){
									if (result.value) {
				...
				echo '<script>
					...
					swal({
						type: "error",
						title: "¡El Area Social no puede ir vacío",
						showConfirmButton: true,
						confirmButtonText: "Cerrar"
						}).then(function(result){
							if (result.value) {
	...
	static public function ctrBorrarServicio(){
		...
		if(isset($_GET["idServicio"])){
			...
			if($respuesta == "ok"){
				...
				swal({
					type: "success",
					title: "El Area Social  ha sido borrado correctamente",
					showConfirmButton: true,
					confirmButtonText: "Cerrar"
					}).then(function(result){
								if (result.value) {
